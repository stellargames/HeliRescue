...
namespace Skytanet.SimpleDatabase
{
    public class SaveFile
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the class. Save files will be saved on the Application.persistentDataPath with the
        ///     specified filename.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the class. Save files will be saved on the specified path with the specified
        ///     filename.
        /// </summary>
        /// <param name="filename">Name of the save file without file extension.</param>
        ...
        private void OpenSaveFile(string filename, string path)
        {
            if (IsOpen())
            {
                Debug.LogError($"You are trying to open an already opened save file ('{filename}')");
                return;
            }
        ...
        public void Set(string key, object value)
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to use 'Set' on a save file that is not open. ('{_filename}')");
                return;
            }
        ...
        public T Get<T>(string key, T defaultValue = default(T))
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to use 'Get' on a save file that is not open. ('{_filename}')");
        ...
        public void Delete(string key)
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to use 'Delete' on a save file that is not open. ('{_filename}')");
                return;
            }
        ...
        public bool HasKey(string key)
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to use 'HasKey()' on a save file that is not open. ('{_filename}')");
                return false;
            }
        ...
        public List<string> GetKeys()
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to use 'getKeys()' on a save file that is not open. ('{_filename}')");
                return null;
            }
        ...
        public void Close()
        {
            if (!IsOpen())
            {
                Debug.LogError($"You are trying to close a save file that is not open. ('{_filename}')");
                return;
            }
